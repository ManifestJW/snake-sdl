...
// Queue a direction change. Invalid turns (reverse direction, repeated direction)
// are ignored. The simulation applies at most one queued turn per tick.
...
// Request growth. Growth is applied on subsequent ticks so movement stays consistent.
